    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='category.jpeg', upload_to='category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=22, max_length=30, prefix='', unique=True)),
                ...
                ('old_price', models.DecimalField(decimal_places=2, default='2.99', max_digits=999999999999999999)),
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('tags', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.tag')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImages',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(default='Addis Ababa', max_length=100)),
                ('contact', models.CharField(default='0943880714', max_length=100)),
